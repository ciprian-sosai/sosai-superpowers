<!-- Derived from official Anthropic documentation on skill authoring best practices.
     Included verbatim for reference. Source: https://docs.anthropic.com/en/docs/agents-and-tools/agent-skills/overview -->
